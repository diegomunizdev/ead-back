...
exports.signin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, correctPassword, token_secret, token, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (user ? user.validatePassword(req.body.password) : false)];
            case 2:
                ...
                token = jsonwebtoken_1.default.sign({ id: user ? user._id : '', type: user ? user.type : '' }, token_secret, {
                    expiresIn: '1d'
                });
                if (!token)
                    return [2 /*return*/, res.status(400).json({
